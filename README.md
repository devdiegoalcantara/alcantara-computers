...
<div id="theproject">
<h2> 📓 The Project </h2>
<p> Computers ecommerce platform </p>
</div>

<div id="target">
<h2> 💡 Target </h2>
Development of Computers ecommerce platform at Start program from Capgemini
</div>
<br>
...
<h2>🧪 How to use</h2>
    <ol &nbsp;>
        ...
        <ul>
            <li>git clone https://github.com/devdiegoalcantara/alcantara-computers-main</li>
        </ul>
        </li>
